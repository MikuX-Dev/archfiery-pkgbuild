...
if [ "$pkgsize" -gt $((100 * 1024)) ]; then
  echo "$package >= 100MB"
  mv /home/builder/.cache/pikaur/pkg/*.pkg.tar.* /home/builder/output-large
else
  mv /home/builder/.cache/pikaur/pkg/*.pkg.tar.* /home/builder/output-small
fi
